      ...
      <div className={classes.container}>
        <div className={classes.inform}>
          <section>
            <h2>What?</h2>
            <p>
              Antwar is a blog aware static site engine built with React and
              Webpack. It&apos;s fast, extensible and friendly.
            </p>
          </section>
          <section>
            <h2>Why?</h2>
            <p>
              The world needed a site engine that was easy to extend and a
      ...
      <section className={classes.callToAction}>
        <div className={classes.container}>
          ...
          <div className={classes.actions}>
            <a className={classes.button} href="/docs/getting-started/">
              Get Started
            </a>
            <a
